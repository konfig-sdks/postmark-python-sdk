...
from postmark_python_sdk.exceptions_base import ApiValueError
from postmark_python_sdk.exceptions import ClientConfigurationError
from postmark_python_sdk.exceptions import InvalidHostConfigurationError
...
conf = postmark_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "http://api.postmarkapp.com" if host is None else host
        """Default Base url
        """
        ...
        self.api_key = {}
        if server_token:
            self.api_key['serverToken'] = server_token
        else:
            raise ClientConfigurationError('API Key "serverToken" is required')
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("postmark_python_sdk")
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'serverToken' in self.api_key:
            auth['serverToken'] = {
                'type': 'api_key',
                'in': 'header',
