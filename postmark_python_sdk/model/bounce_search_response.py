...
class BounceSearchResponse(
        ...
        class properties:
            ...
            class Bounces(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['BounceInfoResponse']:
                        return BounceInfoResponse
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['BounceInfoResponse'], typing.List['BounceInfoResponse']],
                ...
                def __getitem__(self, i: int) -> 'BounceInfoResponse':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Bounces", "TotalCount", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Bounces", "TotalCount", ], str]):
