...
class ExtendedMessageOpenEventInformation(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Client", "FirstOpen", "Geo", "MessageID", "OS", "Platform", "ReceivedAt", "Recipient", "Tag", "UserAgent", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Client", "FirstOpen", "Geo", "MessageID", "OS", "Platform", "ReceivedAt", "Recipient", "Tag", "UserAgent", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        FirstOpen: typing.Union[MetaOapg.properties.FirstOpen, bool, schemas.Unset] = schemas.unset,
