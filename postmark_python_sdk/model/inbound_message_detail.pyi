...
class InboundMessageDetail(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Attachments", "Cc", "CcFull", "Date", "From", "FromFull", "FromName", "MailboxHash", "MessageID", "OriginalRecipient", "ReplyTo", "Status", "Subject", "Tag", "To", "ToFull", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Attachments", "Cc", "CcFull", "Date", "From", "FromFull", "FromName", "MailboxHash", "MessageID", "OriginalRecipient", "ReplyTo", "Status", "Subject", "Tag", "To", "ToFull", ], str]):
        return super().get_item_oapg(name)
