    ...
    async def _aget_dump_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/bounces/{bounceid}/dump',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetDumpRaw(BaseApi):
    ...
    async def aget_dump(
        ...
        **kwargs,
        ...
        args = self._get_dump_mapped_args(
            bounceid=bounceid,
        )
        return await self._aget_dump_oapg(
    ...
    def get_dump(
        ...
        return self._get_dump_oapg(
            path_params=args.path,
        )

class GetDump(BaseApi):
    ...
    async def aget_dump(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_dump(
            bounceid=bounceid,
            **kwargs,
        )
        if validate:
    ...
    def get_dump(
        ...
        raw_response = self.raw.get_dump(
            bounceid=bounceid,
        )
        if validate:
            return Dictionary(**raw_response.body)
