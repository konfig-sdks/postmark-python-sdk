...
class BaseApi(api_client.Api):
    ...
    def _update_bypass_rules_for_inbound_message_mapped_args(
        self,
        messageid: str,
    ...
    async def _aupdate_bypass_rules_for_inbound_message_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/messages/inbound/{messageid}/bypass',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_bypass_rules_for_inbound_message_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class UpdateBypassRulesForInboundMessageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_bypass_rules_for_inbound_message(
        self,
        messageid: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._update_bypass_rules_for_inbound_message_mapped_args(
            messageid=messageid,
        )
        return await self._aupdate_bypass_rules_for_inbound_message_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def update_bypass_rules_for_inbound_message(
        self,
        messageid: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._update_bypass_rules_for_inbound_message_oapg(
            path_params=args.path,
        )

class UpdateBypassRulesForInboundMessage(BaseApi):
    ...
    async def aupdate_bypass_rules_for_inbound_message(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_bypass_rules_for_inbound_message(
            messageid=messageid,
            **kwargs,
        )
        if validate:
    ...
    def update_bypass_rules_for_inbound_message(
        ...
        raw_response = self.raw.update_bypass_rules_for_inbound_message(
            messageid=messageid,
        )
        if validate:
            return StandardPostmarkResponsePydantic(**raw_response.body)
