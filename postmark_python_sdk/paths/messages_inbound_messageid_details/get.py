...
class BaseApi(api_client.Api):
    ...
    def _get_inbound_message_details_mapped_args(
        self,
        messageid: str,
    ...
    async def _aget_inbound_message_details_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/messages/inbound/{messageid}/details',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_inbound_message_details_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetInboundMessageDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_inbound_message_details(
        self,
        messageid: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_inbound_message_details_mapped_args(
            messageid=messageid,
        )
        return await self._aget_inbound_message_details_oapg(
    ...
    def get_inbound_message_details(
        ...
        return self._get_inbound_message_details_oapg(
            path_params=args.path,
        )

class GetInboundMessageDetails(BaseApi):
    ...
    async def aget_inbound_message_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_inbound_message_details(
            messageid=messageid,
            **kwargs,
        )
        if validate:
    ...
    def get_inbound_message_details(
        ...
        raw_response = self.raw.get_inbound_message_details(
            messageid=messageid,
        )
        if validate:
            return Dictionary(**raw_response.body)
