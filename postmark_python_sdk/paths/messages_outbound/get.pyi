...
from postmark_python_sdk.model.outbound_search_response import OutboundSearchResponse as OutboundSearchResponseSchema

from postmark_python_sdk.type.outbound_search_response import OutboundSearchResponse
from postmark_python_sdk.type.standard_postmark_response import StandardPostmarkResponse

from ...api_client import Dictionary
from postmark_python_sdk.pydantic.outbound_search_response import OutboundSearchResponse as OutboundSearchResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = OutboundSearchResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: OutboundSearchResponse
...
class BaseApi(api_client.Api):
    ...
    def _search_outbound_messages_mapped_args(
        self,
        count: int,
        offset: int,
    ...
    async def _asearch_outbound_messages_oapg(
        self,
    ...
    def _search_outbound_messages_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class SearchOutboundMessagesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asearch_outbound_messages(
        self,
        count: int,
        offset: int,
        recipient: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._search_outbound_messages_mapped_args(
            count=count,
            offset=offset,
            recipient=recipient,
            fromemail=fromemail,
        ...
        return await self._asearch_outbound_messages_oapg(
    ...
    def search_outbound_messages(
        ...
        return self._search_outbound_messages_oapg(
            query_params=args.query,
        )

class SearchOutboundMessages(BaseApi):
    ...
    async def asearch_outbound_messages(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OutboundSearchResponsePydantic:
        raw_response = await self.raw.asearch_outbound_messages(
            count=count,
            offset=offset,
            recipient=recipient,
            fromemail=fromemail,
        ...
        if validate:
            return OutboundSearchResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(OutboundSearchResponsePydantic, raw_response.body)
    ...
    def search_outbound_messages(
        ...
        raw_response = self.raw.search_outbound_messages(
            count=count,
            offset=offset,
            recipient=recipient,
            fromemail=fromemail,
