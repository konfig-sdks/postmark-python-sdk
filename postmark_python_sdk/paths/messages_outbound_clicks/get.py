...
class BaseApi(api_client.Api):
    ...
    def _get_all_clicks_mapped_args(
        self,
        count: int,
        offset: int,
    ...
    async def _aget_all_clicks_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/messages/outbound/clicks',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAllClicksRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_clicks(
        self,
        count: int,
        offset: int,
        recipient: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_all_clicks_mapped_args(
            count=count,
            offset=offset,
            recipient=recipient,
            tag=tag,
        ...
        return await self._aget_all_clicks_oapg(
    ...
    def get_all_clicks(
        ...
        return self._get_all_clicks_oapg(
            query_params=args.query,
        )

class GetAllClicks(BaseApi):
    ...
    async def aget_all_clicks(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_all_clicks(
            count=count,
            offset=offset,
            recipient=recipient,
            tag=tag,
    ...
    def get_all_clicks(
        ...
        raw_response = self.raw.get_all_clicks(
            count=count,
            offset=offset,
            recipient=recipient,
            tag=tag,
