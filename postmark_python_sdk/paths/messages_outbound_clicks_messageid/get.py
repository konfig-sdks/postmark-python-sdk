...
class BaseApi(api_client.Api):
    ...
    def _get_message_clicks_mapped_args(
        self,
        messageid: str,
        count: int,
        offset: int,
    ...
    async def _aget_message_clicks_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/messages/outbound/clicks/{messageid}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetMessageClicksRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_message_clicks(
        self,
        messageid: str,
        count: int,
        offset: int,
        **kwargs,
        ...
        args = self._get_message_clicks_mapped_args(
            messageid=messageid,
            count=count,
            offset=offset,
        )
        return await self._aget_message_clicks_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_message_clicks(
        self,
        messageid: str,
        count: int,
        offset: int,
        ...
        return self._get_message_clicks_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetMessageClicks(BaseApi):
    ...
    async def aget_message_clicks(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_message_clicks(
            messageid=messageid,
            count=count,
            offset=offset,
            **kwargs,
    ...
    def get_message_clicks(
        ...
        raw_response = self.raw.get_message_clicks(
            messageid=messageid,
            count=count,
            offset=offset,
        )
