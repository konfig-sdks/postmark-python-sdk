...
class BaseApi(api_client.Api):
    ...
    def _get_outbound_message_details_mapped_args(
        self,
        messageid: str,
    ...
    async def _aget_outbound_message_details_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/messages/outbound/{messageid}/details',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_outbound_message_details_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetOutboundMessageDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_outbound_message_details(
        self,
        messageid: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_outbound_message_details_mapped_args(
            messageid=messageid,
        )
        return await self._aget_outbound_message_details_oapg(
    ...
    def get_outbound_message_details(
        ...
        return self._get_outbound_message_details_oapg(
            path_params=args.path,
        )

class GetOutboundMessageDetails(BaseApi):
    ...
    async def aget_outbound_message_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_outbound_message_details(
            messageid=messageid,
            **kwargs,
        )
        if validate:
    ...
    def get_outbound_message_details(
        ...
        raw_response = self.raw.get_outbound_message_details(
            messageid=messageid,
        )
        if validate:
            return Dictionary(**raw_response.body)
