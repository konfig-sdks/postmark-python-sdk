...
class BaseApi(api_client.Api):
    ...
    def _get_message_dump_mapped_args(
        self,
        messageid: str,
    ...
    async def _aget_message_dump_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/messages/outbound/{messageid}/dump',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetMessageDumpRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_message_dump(
        self,
        messageid: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_message_dump_mapped_args(
            messageid=messageid,
        )
        return await self._aget_message_dump_oapg(
    ...
    def get_message_dump(
        ...
        return self._get_message_dump_oapg(
            path_params=args.path,
        )

class GetMessageDump(BaseApi):
    ...
    async def aget_message_dump(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_message_dump(
            messageid=messageid,
            **kwargs,
        )
        if validate:
    ...
    def get_message_dump(
        ...
        raw_response = self.raw.get_message_dump(
            messageid=messageid,
        )
        if validate:
            return Dictionary(**raw_response.body)
