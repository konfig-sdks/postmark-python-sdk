...
from postmark_python_sdk.model.outbound_overview_stats_response import OutboundOverviewStatsResponse as OutboundOverviewStatsResponseSchema

from postmark_python_sdk.type.outbound_overview_stats_response import OutboundOverviewStatsResponse
...
from postmark_python_sdk.pydantic.outbound_overview_stats_response import OutboundOverviewStatsResponse as OutboundOverviewStatsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = OutboundOverviewStatsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: OutboundOverviewStatsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_outbound_overview_mapped_args(
        self,
    ...
    async def _aget_outbound_overview_oapg(
        self,
    ...
    def _get_outbound_overview_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetOutboundOverviewRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_outbound_overview(
        self,
        tag: typing.Optional[str] = None,
        fromdate: typing.Optional[date] = None,
        todate: typing.Optional[date] = None,
        **kwargs,
        ...
        args = self._get_outbound_overview_mapped_args(
            tag=tag,
            fromdate=fromdate,
            todate=todate,
        )
        return await self._aget_outbound_overview_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_outbound_overview(
        self,
        tag: typing.Optional[str] = None,
        fromdate: typing.Optional[date] = None,
        todate: typing.Optional[date] = None,
        ...
        return self._get_outbound_overview_oapg(
            query_params=args.query,
        )

class GetOutboundOverview(BaseApi):
    ...
    async def aget_outbound_overview(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OutboundOverviewStatsResponsePydantic:
        raw_response = await self.raw.aget_outbound_overview(
            tag=tag,
            fromdate=fromdate,
            todate=todate,
            **kwargs,
        ...
        if validate:
            return OutboundOverviewStatsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(OutboundOverviewStatsResponsePydantic, raw_response.body)
    ...
    def get_outbound_overview(
        ...
        raw_response = self.raw.get_outbound_overview(
            tag=tag,
            fromdate=fromdate,
            todate=todate,
        )
