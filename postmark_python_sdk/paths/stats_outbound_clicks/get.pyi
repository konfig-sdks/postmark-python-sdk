...
class BaseApi(api_client.Api):
    ...
    def _get_outbound_click_counts_mapped_args(
        self,
    ...
    async def _aget_outbound_click_counts_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/stats/outbound/clicks',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_outbound_click_counts_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetOutboundClickCountsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_outbound_click_counts(
        self,
        tag: typing.Optional[str] = None,
        fromdate: typing.Optional[date] = None,
        todate: typing.Optional[date] = None,
        **kwargs,
        ...
        args = self._get_outbound_click_counts_mapped_args(
            tag=tag,
            fromdate=fromdate,
            todate=todate,
        )
        return await self._aget_outbound_click_counts_oapg(
    ...
    def get_outbound_click_counts(
        ...
        return self._get_outbound_click_counts_oapg(
            query_params=args.query,
        )

class GetOutboundClickCounts(BaseApi):
    ...
    async def aget_outbound_click_counts(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_outbound_click_counts(
            tag=tag,
            fromdate=fromdate,
            todate=todate,
            **kwargs,
    ...
    def get_outbound_click_counts(
        ...
        raw_response = self.raw.get_outbound_click_counts(
            tag=tag,
            fromdate=fromdate,
            todate=todate,
        )
