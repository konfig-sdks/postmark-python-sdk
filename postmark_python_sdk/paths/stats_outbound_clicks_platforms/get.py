...
class BaseApi(api_client.Api):
    ...
    def _get_browser_platform_usage_mapped_args(
        self,
    ...
    async def _aget_browser_platform_usage_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/stats/outbound/clicks/platforms',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_browser_platform_usage_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetBrowserPlatformUsageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_browser_platform_usage(
        self,
        tag: typing.Optional[str] = None,
        fromdate: typing.Optional[date] = None,
        todate: typing.Optional[date] = None,
        **kwargs,
        ...
        args = self._get_browser_platform_usage_mapped_args(
            tag=tag,
            fromdate=fromdate,
            todate=todate,
        )
        return await self._aget_browser_platform_usage_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_browser_platform_usage(
        self,
        tag: typing.Optional[str] = None,
        fromdate: typing.Optional[date] = None,
        todate: typing.Optional[date] = None,
        ...
        return self._get_browser_platform_usage_oapg(
            query_params=args.query,
        )

class GetBrowserPlatformUsage(BaseApi):
    ...
    async def aget_browser_platform_usage(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_browser_platform_usage(
            tag=tag,
            fromdate=fromdate,
            todate=todate,
            **kwargs,
    ...
    def get_browser_platform_usage(
        ...
        raw_response = self.raw.get_browser_platform_usage(
            tag=tag,
            fromdate=fromdate,
            todate=todate,
        )
