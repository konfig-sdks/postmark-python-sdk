...
from postmark_python_sdk.model.sent_counts_response import SentCountsResponse as SentCountsResponseSchema

from postmark_python_sdk.type.sent_counts_response import SentCountsResponse
from postmark_python_sdk.type.standard_postmark_response import StandardPostmarkResponse

from ...api_client import Dictionary
from postmark_python_sdk.pydantic.sent_counts_response import SentCountsResponse as SentCountsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = SentCountsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: SentCountsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_sent_counts_mapped_args(
        self,
    ...
    async def _aget_sent_counts_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/stats/outbound/sends',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetSentCountsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_sent_counts(
        self,
        tag: typing.Optional[str] = None,
        fromdate: typing.Optional[date] = None,
        todate: typing.Optional[date] = None,
        **kwargs,
        ...
        args = self._get_sent_counts_mapped_args(
            tag=tag,
            fromdate=fromdate,
            todate=todate,
        )
        return await self._aget_sent_counts_oapg(
    ...
    def get_sent_counts(
        ...
        return self._get_sent_counts_oapg(
            query_params=args.query,
        )

class GetSentCounts(BaseApi):
    ...
    async def aget_sent_counts(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SentCountsResponsePydantic:
        raw_response = await self.raw.aget_sent_counts(
            tag=tag,
            fromdate=fromdate,
            todate=todate,
            **kwargs,
        ...
        if validate:
            return SentCountsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(SentCountsResponsePydantic, raw_response.body)
    ...
    def get_sent_counts(
        ...
        raw_response = self.raw.get_sent_counts(
            tag=tag,
            fromdate=fromdate,
            todate=todate,
        )
