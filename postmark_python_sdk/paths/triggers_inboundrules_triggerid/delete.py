...
# Path params
TriggeridSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'triggerid': typing.Union[TriggeridSchema, decimal.Decimal, int, ],
    }
)
...
request_path_triggerid = api_client.PathParameter(
    name="triggerid",
...
class BaseApi(api_client.Api):
    ...
    def _delete_single_trigger_mapped_args(
        self,
        triggerid: int,
    ...
    async def _adelete_single_trigger_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/triggers/inboundrules/{triggerid}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _delete_single_trigger_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteSingleTriggerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_single_trigger(
        self,
        triggerid: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_single_trigger_mapped_args(
            triggerid=triggerid,
        )
        return await self._adelete_single_trigger_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_single_trigger(
        self,
        triggerid: int,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._delete_single_trigger_oapg(
            path_params=args.path,
        )

class DeleteSingleTrigger(BaseApi):
    ...
    async def adelete_single_trigger(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_single_trigger(
            triggerid=triggerid,
            **kwargs,
        )
        if validate:
    ...
    def delete_single_trigger(
        ...
        raw_response = self.raw.delete_single_trigger(
            triggerid=triggerid,
        )
        if validate:
            return StandardPostmarkResponsePydantic(**raw_response.body)
