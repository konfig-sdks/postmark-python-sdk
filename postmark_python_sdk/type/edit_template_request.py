...
class RequiredEditTemplateRequest(TypedDict):
    pass

class OptionalEditTemplateRequest(TypedDict, total=False):
...
class EditTemplateRequest(RequiredEditTemplateRequest, OptionalEditTemplateRequest):
    pass
